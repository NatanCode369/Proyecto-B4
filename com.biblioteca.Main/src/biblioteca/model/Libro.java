...
public class Libro {
    ...
    public Libro(Integer book_id, String isbn, String title, String author, String publisher, Integer publication_year, Integer total_stock, Integer available_stock, Boolean active) {
