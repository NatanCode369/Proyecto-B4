...
public class SolicitudPrestamo {
    ...
    public SolicitudPrestamo(Integer request_id, Integer student_id, LocalDate request_date, EstadoSolicitud status, String observation, Integer librarian_id, LocalDate response_date) {
