...
public class Prestamo {
    ...
    public Prestamo(Integer loan_id, Integer request_id, Integer student_id, Integer librarian_id, LocalDate loan_date, LocalDate due_date, EstadoPrestamo status) {
    ...
    public EstadoPrestamo getStatus() { return status; }
    public void setStatus(EstadoPrestamo status) { this.status = status; }
}
