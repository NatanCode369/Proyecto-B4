...
create table Estudiante(
    ...
    contrasena_estudiante varchar(50) not null,
...
create table Jefe(
    ...
    contrasena_jefe varchar(30) not null,
...
create table Bibliotecario(
    ...
    correo_bibliotecario varchar(50) not null,
    contrasena_bibliotecario varchar(30) not null,
...
-- LOGIN JEFE
Delimiter $$
create procedure sp_login_jefe(
    in correo_jefe_p varchar(50),
    in contrasena_jefe_p varchar(30)
)
begin
    select * from Jefe
    where correo_jefe = correo_jefe_p
      and contrasena_jefe = contrasena_jefe_p;
end$$
Delimiter ;

-- LOGIN BIBLIOTECARIO
Delimiter $$
create procedure sp_login_bibliotecario(
    in correo_bibliotecario_p varchar(50),
    in contrasena_bibliotecario_p varchar(30)
)
begin
    select * from Bibliotecario
    where correo_bibliotecario = correo_bibliotecario_p
      and contrasena_bibliotecario = contrasena_bibliotecario_p;
end$$
Delimiter ;
...
create procedure sp_login_estudiante(
    in correo_estudiante_p varchar(50),
    in contrasena_estudiante_p varchar(50)
)
begin
    select * from Estudiante
    where correo_estudiante = correo_estudiante_p
      and contrasena_estudiante = contrasena_estudiante_p;
end$$
Delimiter ;
...
begin
    insert into Estudiante(nombre_estudiante, apellido_estudiante, correo_estudiante, contrasena_estudiante)
    values(nombre_estudiante_p, apellido_estudiante_p, correo_estudiante_p, contrasena_estudiante_p);
end$$
Delimiter ;
...
begin
    ...
    set
        ...
        correo_estudiante = correo_estudiante_p,
        contrasena_estudiante = contrasena_estudiante_p
...
-- DELETE
Delimiter $$
create procedure sp_delete_estudiante(in ID_estudiante_p int)
begin
...
-- SEARCH
Delimiter $$
create procedure sp_search_estudiante(in ID_estudiante_p int)
begin
...
begin
    insert into Jefe(nombre_jefe, apellido_jefe, correo_jefe, contrasena_jefe)
    values(nombre_jefe_p, apellido_jefe_p, correo_jefe_p, contrasena_jefe_p);
end$$
Delimiter ;
/*
-- READ
...
begin
    ...
    set
        ...
        correo_jefe = correo_jefe_p,
        contrasena_jefe = contrasena_jefe_p
...
-- DELETE
Delimiter $$
create procedure sp_delete_jefe(in ID_jefe_p int)
begin
...
-- SEARCH
Delimiter $$
create procedure sp_search_jefe(in ID_jefe_p int)
begin
...
begin
    insert into Bibliotecario(nombre_bibliotecario, apellido_bibliotecario, correo_bibliotecario, contrasena_bibliotecario)
    values(nombre_bibliotecario_p, apellido_bibliotecario_p, correo_bibliotecario_p, contrasena_bibliotecario_p);
end$$
Delimiter ;
/*
-- READ
...
begin
    ...
    set
        ...
        correo_bibliotecario = correo_bibliotecario_p,
        contrasena_bibliotecario = contrasena_bibliotecario_p
...
-- DELETE
Delimiter $$
create procedure sp_delete_bibliotecario(in ID_bibliotecario_p int)
begin
...
-- SEARCH
Delimiter $$
create procedure sp_search_bibliotecario(in ID_bibliotecario_p int)
begin
...
begin
    insert into Prestamo(ID_estudiante, ISBN, fecha_adquisicion, fecha_vencimiento, aprobacion_prestamo)
    values(ID_estudiante_p, ISBN_p, fecha_adquisicion_p, fecha_vencimiento_p, aprobacion_prestamo_p);
end$$
Delimiter ;
...
-- DELETE
Delimiter $$
create procedure sp_delete_prestamo(in ID_prestamo_p int)
begin
...
-- SEARCH
Delimiter $$
create procedure sp_search_prestamo(in ID_prestamo_p int)
begin
